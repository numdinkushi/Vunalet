        ...
        <div className="min-h-screen pt-20 bg-gradient-to-br from-gray-50 to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {realFarmers && realFarmers.length > 0 && (
                    ...
                    >
                        <div className="mb-12">
                            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Farmers</h2>
                            <p className="text-xl text-gray-600">Real farmers from our platform</p>
                        </div>
