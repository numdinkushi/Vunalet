            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {farmers.map((farmer, index) => (
                        <motion.div
                            key={farmer.id}
                            className="group bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500"
                            ...
                            <div className="flex items-center mb-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 font-semibold text-gray-900">{farmer.rating}</span>
                                        <span className="ml-2 text-sm text-gray-500">({farmer.customers} customers)</span>
                                    </div>
                                </div>
                            </div>

                            <p className="text-gray-600 mb-6 leading-relaxed">{farmer.description}</p>

                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div className="bg-gray-50 rounded-2xl p-4">
                                    <div className="text-sm text-gray-500 mb-1">Farm Size</div>
                                    <div className="font-semibold text-gray-900">{farmer.farmSize}</div>
                                </div>
                                <div className="bg-gray-50 rounded-2xl p-4">
                                    <div className="text-sm text-gray-500 mb-1">Products</div>
                                    <div className="font-semibold text-gray-900">{farmer.totalProducts}</div>
                                </div>
                                <div className="bg-gray-50 rounded-2xl p-4">
                                    <div className="text-sm text-gray-500 mb-1">Experience</div>
                                    <div className="font-semibold text-gray-900">{farmer.experience}</div>
                                </div>
                                <div className="bg-gray-50 rounded-2xl p-4">
                                    <div className="text-sm text-gray-500 mb-1">Customers</div>
                                    <div className="font-semibold text-gray-900">{farmer.customers}</div>
                                </div>
                            </div>

                            <div className="mb-6">
                                <div className="text-sm text-gray-500 mb-3">Specialties</div>
