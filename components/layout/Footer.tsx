...
export function Footer() {
  ...
  const quickLinks = [
    ...
    { name: 'Contact', href: '/about' }, // Using about page for contact since no dedicated contact page
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <div className="text-gray-300 p-2 bg-gray-800 rounded-full">
                  <Phone size={20} />
                </div>
                <div className="text-gray-300 p-2 bg-gray-800 rounded-full">
                  <Mail size={20} />
